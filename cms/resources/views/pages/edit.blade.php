# filepath: /c:/Users/user/Desktop/CMS-project/cms/resources/views/pages/edit.blade.php
<!DOCTYPE html>
<html lang="en">
...
<body class="font-inter bg-gray-50">
    ...
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold mb-4">Editar Página</h1>
        ...
        <form action="{{ route('pages.update', $page->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" class="w-full px-4 py-2 border rounded-lg" required>{{ $page->content }}</textarea>
            </div>
            ...
            <div class="mb-4">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Actualizar Página</button>
            </div>
        </form>
    </div>
