                        ...
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div class="text-center text-sm text-gray-600 mb-4">
                                <p>¿Recordaste tu contraseña? 
                                    <a href="{{ route('login') }}" class="text-cyan-600 hover:text-cyan-700 focus:text-cyan-700">Inicia sesión</a>
                                </p>
                            </div>
                            ...
                            <div class="text-center text-sm text-gray-600 mt-6">
                                <p>¿No tienes una cuenta? 
                                    <a href="{{ route('register') }}" class="text-cyan-600 hover:text-cyan-700 focus:text-cyan-700">Crea una aquí</a>
                                </p>
                            </div>
                        </div>
                    </div>
