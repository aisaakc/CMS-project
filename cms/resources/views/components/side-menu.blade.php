            ...
            <form action="">
                <nav class="flex flex-col space-y-2 p-4 text-gray-300">
                    ...
                    <a href="{{ route('dashboard') }}"
                       class="flex items-center space-x-3 bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-300 shadow-md">
                        <div class="bg-gray-700 p-2 rounded-full hover:bg-gray-600 transform transition duration-300 hover:-translate-y-1">
